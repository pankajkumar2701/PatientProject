...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "PatientProject", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<PatientProjectContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "PatientProject API v1");
