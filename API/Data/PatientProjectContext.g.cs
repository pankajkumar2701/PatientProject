...
namespace PatientProject.Data
{
    ...
    /// </summary>
    public class PatientProjectContext : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-GFUVFUP;Initial Catalog=T238325_PatientProject;Persist Security Info=True;user id=pankazz;password=123456;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
