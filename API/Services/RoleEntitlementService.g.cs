...
using PatientProject.Filter;
using PatientProject.Entities;
using PatientProject.Logger;
...
namespace PatientProject.Services
{
    /// <summary>
    ...
    {
        private readonly PatientProjectContext _dbContext;
        ...
        public RoleEntitlementService(PatientProjectContext dbContext, IFieldMapperService mapper)
        {
